...
package com.gzqining.inthegarden.waterflow.internal;
...
import com.gzqining.inthegarden.waterflow.DebugUtil;
...
//        int i=Math.max( 0, mFirstPosition - getHeaderViewsCount());
//    	if(i<=0){
//    		i=0;
//    	}
        return mFirstPosition;//ԭ���Ƿ���i
    }

    @Override
    public int getLastVisiblePosition() {
    	int i=Math.min( mFirstPosition + getChildCount() - 1, mAdapter.getCount() - 1);
    	if(i<=0){
    		i=0;
    	}
        return i;
