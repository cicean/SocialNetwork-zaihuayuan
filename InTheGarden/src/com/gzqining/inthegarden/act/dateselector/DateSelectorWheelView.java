...
import com.gzqining.inthegarden.util.DateUtil;
import com.gzqining.inthegarden.act.dateselector.OnWheelChangedListener;
import com.gzqining.inthegarden.act.dateselector.StrericWheelAdapter;
...
private String[] years = new String[300];
...
LayoutInflater.from(context).inflate(R.layout.dialog_date_layout, this,
		true);
...
wvYear.setCurrentItem(years.length / 2-60);//初始化显示的年份
...
tvYear.setText(DateUtil.splitDateString(wvYear.getCurrentItemValue()));
tvMonth.setText(DateUtil.splitDateString(wvMonth.getCurrentItemValue()));
tvDay.setText(DateUtil.splitDateString(wvDay.getCurrentItemValue()));
}
...
case R.id.wv_date_of_month:
	trim = DateUtil.splitDateString(wvMonth.getCurrentItemValue())
			.trim();
	...
	case 12:
		...
		break;
	case 2:
		String yearString = DateUtil.splitDateString(
				wvYear.getCurrentItemValue()).trim();
