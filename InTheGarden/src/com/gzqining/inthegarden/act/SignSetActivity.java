...
public class SignSetActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_sign_set);
	...
	private void initView() {
		back_btn = (ImageButton)findViewById(R.id.top_layout_sign_back_btn);
		right = (ImageButton) findViewById(R.id.top_layout_sign_right_btn);
		sign_tv = (EditText) findViewById(R.id.sign_set);
	}
	...
	private void initEvents() {
		...
		right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if (sign_tv.getText().toString()!=null){
					signHttpPost();
				}else{
					Intent intent = new Intent(SignSetActivity.this, MyInfoActivity.class);
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.top_layout_sign_back_btn:
	...
	public void signHttpPost() {
		...
		bean.setIntro(sign_tv.getText().toString());
