...
public class PhoneSetActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_phone_set);
		...
		right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (nickName_et.getText().toString()!=null){
					...
					Intent intent = new Intent(PhoneSetActivity.this, MyInfoActivity.class);
